! function() {
    ...
    function a() {
        var t = $('<li class="menu__item selector" data-action="okko"><div class="menu__ico">' + e + '</div><div class="menu__text">Okko</div></li>');
    ...
    function o() {
        var t = $('<li class="menu__item selector" data-action="ivi"><div class="menu__ico">' + e + '</div><div class="menu__text">ИВИ</div></li>');
        t.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    function n() {
        var t = $('<li class="menu__item selector" data-action="wink"><div class="menu__ico">' + e + '</div><div class="menu__text">Wink</div></li>');
        t.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    function i() {
        var t = $('<li class="menu__item selector" data-action="kion"><div class="menu__ico">' + e + '</div><div class="menu__text">KION</div></li>');
        t.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    function r() {
        var t = $('<li class="menu__item selector" data-action="netflix"><div class="menu__ico">' + e + '</div><div class="menu__text">Netflix (серіали)</div></li>');
        t.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    function c() {
        var t = $('<li class="menu__item selector" data-action="rus"><div class="menu__ico">' + e + '</div><div class="menu__text">Русские</div></li>');
        t.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    function l() {
        var t = $('<li class="menu__item selector" data-action="kr"><div class="menu__ico">' + e + '</div><div class="menu__text">Дорамы</div></li>');
        t.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    function p() {
        var t = $('<li class="menu__item selector" data-action="kp"><div class="menu__ico">' + e + '</div><div class="menu__text">Кинопоиск</div></li>');
        t.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    function u() {
        var e = $('<li class="menu__item selector" data-action="mult_tmdb"><div class="menu__ico"><svg viewBox="0 0 514 514" xmlns="http://www.w3.org/2000/svg"><path d="m400 2c-79 6-142 75-142 156v14h-99l-98 1-5 2c-38 17-23 63 21 65h15l-3 6c-10 20-10 24-11 76v45l-5-8c-7-12-13-26-18-39-5-15-6-17-11-21-13-12-35-7-41 10-6 16 17 70 46 105 116 145 347 127 439-34 31-54 31-87-1-87-15 0-21 5-28 27-6 18-28 58-31 58-1 0-1-22-1-49v-50l-11-55c-12-60-12-58-6-63 8-7 15-3 24 11 14 24 29 30 47 21 20-9 21-17 10-71-10-52-10-53 2-53s21-14 20-28c-1-6-2-7-10-13-30-20-65-29-103-26m43 74c-10 3-14 17-6 25 13 13 32-4 23-19-3-5-11-8-17-6m-289 114v27l1 26 2 3 3 3h46 46l3-3 2-3v-27-27h-51c-36 0-51 0-52 1m78 116c-54 9-96 54-102 109l-1 6 10 6c70 45 158 47 230 4 9-5 8-4 7-15-7-71-73-122-144-110" fill="currentColor" fill-rule="evenodd"/></svg></div><div class="menu__text">Мультфильмы</div></li>');
        e.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    function s() {
        var e = $('<li class="menu__item selector" data-action="nickelodeon"><div class="menu__ico"><svg viewBox="0 0 514 514" xmlns="http://www.w3.org/2000/svg"><path d="m400 2c-79 6-142 75-142 156v14h-99l-98 1-5 2c-38 17-23 63 21 65h15l-3 6c-10 20-10 24-11 76v45l-5-8c-7-12-13-26-18-39-5-15-6-17-11-21-13-12-35-7-41 10-6 16 17 70 46 105 116 145 347 127 439-34 31-54 31-87-1-87-15 0-21 5-28 27-6 18-28 58-31 58-1 0-1-22-1-49v-50l-11-55c-12-60-12-58-6-63 8-7 15-3 24 11 14 24 29 30 47 21 20-9 21-17 10-71-10-52-10-53 2-53s21-14 20-28c-1-6-2-7-10-13-30-20-65-29-103-26m43 74c-10 3-14 17-6 25 13 13 32-4 23-19-3-5-11-8-17-6m-289 114v27l1 26 2 3 3 3h46 46l3-3 2-3v-27-27h-51c-36 0-51 0-52 1m78 116c-54 9-96 54-102 109l-1 6 10 6c70 45 158 47 230 4 9-5 8-4 7-15-7-71-73-122-144-110" fill="currentColor" fill-rule="evenodd"/></svg></div><div class="menu__text">Nickelodeon</div></li>');
        e.on("hover:enter", (function() {
            Lampa.Activity.push({
    ...
    window.plugin_podbor_ready || function() {
        function e() {
            window.plugin_podbor_ready || setTimeout((function() {
                "1" == Lampa.Storage.get("porborki_kach") && t(), "1" == Lampa.Storage.get("porborki_rus") && c(), "1" == Lampa.Storage.get("porborki_okko") && a(), "1" == Lampa.Storage.get("porborki_ivi") && o(), "1" == Lampa.Storage.get("porborki_wink") && n(), "1" == Lampa.Storage.get("porborki_kion") && i(), "1" == Lampa.Storage.get("porborki_netflix") && r(), "1" == Lampa.Storage.get("porborki_kr") && l(), "1" == Lampa.Storage.get("porborki_kp") && p(), "1" == Lampa.Storage.get("porborki_mult12") && u(), "1" == Lampa.Storage.get("porborki_mult13") && m(), "1" != Lampa.Storage.get("porborki_mult14") && "0" == Lampa.Storage.get("porborki_mult14") || v(), "1" == Lampa.Storage.get("porborki_mult15") && s(), "1" == Lampa.Storage.get("porborki_mult16") && d()
            }), 500), window.plugin_podbor_ready = !0, Lampa.SettingsApi.addComponent({
                component: "porborki",
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_mult14", e), 1 == e ? 0 == $('[data-action="mult_cub"]').length && v() : $('[data-action="mult_cub"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki_mult",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_mult12", e), 1 == e ? 0 == $('[data-action="mult_tmdb"]').length && u() : $('[data-action="mult_tmdb"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki_mult",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_mult15", e), 1 == e ? 0 == $('[data-action="nickelodeon"]').length && s() : $('[data-action="nickelodeon"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki_mult",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_mult13", e), 1 == e ? 0 == $('[data-action="mult_series"]').length && m() : $('[data-action="mult_series"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_rus", e), 1 == e ? 0 == $('[data-action="rus"]').length && c() : $('[data-action="rus"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_kach", e), 1 == e ? 0 == $('[data-action="hd"]').length && t() : $('[data-action="hd"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_okko", e), 1 == e ? 0 == $('[data-action="okko"]').length && a() : $('[data-action="okko"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_kp", e), 1 == e ? 0 == $('[data-action="kp"]').length && p() : $('[data-action="kp"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_ivi", e), 1 == e ? 0 == $('[data-action="ivi"]').length && o() : $('[data-action="ivi"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_wink", e), 1 == e ? 0 == $('[data-action="wink"]').length && n() : $('[data-action="wink"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_kion", e), 1 == e ? 0 == $('[data-action="kion"]').length && i() : $('[data-action="kion"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_netflix", e), 1 == e ? 0 == $('[data-action="netflix"]').length && r() : $('[data-action="netflix"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_kr", e), 1 == e ? 0 == $('[data-action="kr"]').length && l() : $('[data-action="kr"]').remove()
                }
            }), Lampa.SettingsApi.addParam({
                component: "porborki",
                param: {
                    name: "porborki_mult16",
                    type: "select",
                    values: {
                        1: "Показать",
                        0: "Скрыть"
                ...
                onChange: function(e) {
                    Lampa.Storage.set("porborki_mult16", e), 1 == e ? 0 == $('[data-action="animes"]').length && d() : $('[data-action="animes"]').remove()
                }
            })
        }
        window.appready ? e() : Lampa.Listener.follow("app", (function(t) {
            "ready" == t.type && e()
        }))
    }()
}();